...
/**
 * JDBC {@link Connection} wrapper that ensures statements use Hive-aware wrappers.
 */
public class ConnectionWrapper implements Connection {
  private final Connection wrappedConnection;

  /**
   * Creates a wrapper around a JDBC connection.
   *
  ...
  public Statement createStatement() throws SQLException {
    return new StatementWrapper(wrappedConnection.createStatement());
  }

  @Override
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return new PreparedStatementWrapper(wrappedConnection.prepareStatement(sql));
  }
  ...
  public CallableStatement prepareCall(
      ...
      int resultSetConcurrency,
      int resultSetHoldability) throws SQLException {
    return wrappedConnection.prepareCall(
        sql, resultSetType, resultSetConcurrency, resultSetHoldability);
  }
