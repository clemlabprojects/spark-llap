...
/**
 * Spark DataSource V2 table for HWC batch streaming writes.
 */
public class HiveStreamingDataSource implements Table, SupportsWrite, SessionConfigSupport {
  ...
  /**
   * Indicates support for externally supplied metadata.
   *
   * @return true if external metadata is supported
   */
  @Override
  ...
  public WriteBuilder newWriteBuilder(LogicalWriteInfo logicalWriteInfo) {
    return new HiveStreamingDataSourceWriterBuilder(logicalWriteInfo);
  }
